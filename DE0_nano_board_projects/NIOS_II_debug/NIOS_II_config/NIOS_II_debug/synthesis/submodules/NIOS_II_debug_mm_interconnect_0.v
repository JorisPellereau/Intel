...
module NIOS_II_debug_mm_interconnect_0 (
	...
	wire  [93:0] pi_adc_data_s1_agent_rf_source_data;                                       // pi_adc_data_s1_agent:rf_source_data -> pi_adc_data_s1_agent_rsp_fifo:in_data
	...
	wire  [93:0] pi_adc_data_s1_agent_rsp_fifo_out_data;                                    // pi_adc_data_s1_agent_rsp_fifo:out_data -> pi_adc_data_s1_agent:rf_sink_data
	...
	wire  [92:0] cmd_mux_004_src_data;                                                      // cmd_mux_004:src_data -> pi_adc_data_s1_agent:cp_data
	wire         cmd_mux_004_src_ready;                                                     // pi_adc_data_s1_agent:cp_ready -> cmd_mux_004:src_ready
	wire   [6:0] cmd_mux_004_src_channel;                                                   // cmd_mux_004:src_channel -> pi_adc_data_s1_agent:cp_channel
	...
	wire  [93:0] pi_adc_channel_data_valid_s1_agent_rf_source_data;                         // pi_adc_channel_data_valid_s1_agent:rf_source_data -> pi_adc_channel_data_valid_s1_agent_rsp_fifo:in_data
	...
	wire  [93:0] pi_adc_channel_data_valid_s1_agent_rsp_fifo_out_data;                      // pi_adc_channel_data_valid_s1_agent_rsp_fifo:out_data -> pi_adc_channel_data_valid_s1_agent:rf_sink_data
	...
	wire  [92:0] cmd_mux_005_src_data;                                                      // cmd_mux_005:src_data -> pi_adc_channel_data_valid_s1_agent:cp_data
	wire         cmd_mux_005_src_ready;                                                     // pi_adc_channel_data_valid_s1_agent:cp_ready -> cmd_mux_005:src_ready
	wire   [6:0] cmd_mux_005_src_channel;                                                   // cmd_mux_005:src_channel -> pi_adc_channel_data_valid_s1_agent:cp_channel
	...
	wire  [93:0] po_adc_cmd_s1_agent_rf_source_data;                                        // po_adc_cmd_s1_agent:rf_source_data -> po_adc_cmd_s1_agent_rsp_fifo:in_data
	...
	wire  [93:0] po_adc_cmd_s1_agent_rsp_fifo_out_data;                                     // po_adc_cmd_s1_agent_rsp_fifo:out_data -> po_adc_cmd_s1_agent:rf_sink_data
	...
	wire  [92:0] cmd_mux_006_src_data;                                                      // cmd_mux_006:src_data -> po_adc_cmd_s1_agent:cp_data
	wire         cmd_mux_006_src_ready;                                                     // po_adc_cmd_s1_agent:cp_ready -> cmd_mux_006:src_ready
	wire   [6:0] cmd_mux_006_src_channel;                                                   // cmd_mux_006:src_channel -> po_adc_cmd_s1_agent:cp_channel
	...
	wire  [92:0] pi_adc_data_s1_agent_rp_data;                                              // pi_adc_data_s1_agent:rp_data -> router_006:sink_data
	...
	wire  [92:0] pi_adc_channel_data_valid_s1_agent_rp_data;                                // pi_adc_channel_data_valid_s1_agent:rp_data -> router_007:sink_data
	...
	wire  [92:0] po_adc_cmd_s1_agent_rp_data;                                               // po_adc_cmd_s1_agent:rp_data -> router_008:sink_data
